...
public class Property {
	...
	private double dwellingStyle = 0; //changed to double
	 ...
	 */
	public double getDwellingStyle() { //Changed to Double to fix Ticket #4
		return dwellingStyle;
	}
	/**
	 * @param d the dwellingStyle to set
	 */
	public void setDwellingStyle(final double d) {//Changed to double to fix Ticket #4
