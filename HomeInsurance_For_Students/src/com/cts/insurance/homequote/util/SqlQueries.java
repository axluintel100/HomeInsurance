...
public final class SqlQueries {
	...
	public static final String SAVE_LOCATION = "INSERT INTO Location (RESIDENCE_TYPE, " +
	...
	public static final String GET_LOCATION = "select * from Location where QUOTE_ID = ?";
	...
	public static final String GET_LOCS_FOR_USER = "select * from Location where USER_NAME = ?";
	public static final String GET_ALL_DETAILS = "select * from Location l, HomeownerInfo h, Propertys p, Quote q " +
	...
	public static final String GET_POLICIES = "SELECT * from Policys p, Location l where p.QUOTE_ID= l.QUOTE_ID and l.USER_NAME = ?";
