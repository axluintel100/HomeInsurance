...
function validate(registration) {
	...
	if(registration.userName.length > 20)
	{
			alert("Please enter a username smaller than 20 characters");
			registration.userName.focus();
			return false;
	}
	...
	{
			alert("Please enter a password smaller than 20 characters");
			registration.password.focus();
			return false;
	}
	
	if (registration.confirmPass.value=="")
	{
		alert("Please confirm password");
		registration.confirmPass.focus();
		return false;
	}	
	if (registration.password.value!=registration.confirmPass.value)
	{
	...
	<table>
		...
		<tr>
			<td colspan=2 align="center"><input type="submit" value="Login"
				onclick="return validate(registration);" />
			</td>
		</tr>
	</table>
</form>
