...
function validateForm(homeowner) {
	...
	if(homeowner.firstName.value=="")
	{
		...
		if(homeowner.firstName.length > 20)
		{
			alert("Please enter a first name smaller than 20 characters");
	...
	if(homeowner.lastName.value=="")
	{
		...
		if(homeowner.lastName.length > 20)
		{
			alert("Please enter a last name smaller than 20 characters");
			homeowner.lastName.focus();
			return false;
		}	
	}
	...
	{
		if(!homeowner.dob.value.test(date_pattern))
		{
			alert("Please nter a valid date of birth")
			homeowner.dob.focus
			return false;
		}
